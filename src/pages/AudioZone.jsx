  ...
  return (
    ...
    <div className='w-full min-h-screen p-4 mx-auto'>
        <div className='flex items-center justify-center relative py-4'>
            ...
            <h4 className='text-2xl font-semibold text-white'>Audio Zone</h4>
        </div>
        <div className='mb-3'>
            <h5 className='text-lg font-bold text-white py-2 mb-2'>Psixologiya</h5>
            <Slider {...settings}>
        ...
        <div className='mb-3'>
            <h5 className='text-lg font-bold text-white py-2 mb-2'>Biznes</h5>
            <Slider {...settings}>
                <div className='flex flex-col pr-2'>
                    <div className='h-[132px] rounded-xl overflow-hidden'>
                        <img src="/assets/images/zone-img1.png" className='w-full' alt="Zones Image" />
        ...
        <div className='mb-3'>
            <h5 className='text-lg font-bold text-white py-2 mb-2'>Tarix</h5>
            <Slider {...settings}>
                <div className='flex flex-col pr-2'>
                    <div className='h-[132px] rounded-xl overflow-hidden'>
                        <img src="/assets/images/zone-img1.png" className='w-full' alt="Zones Image" />
